...
const businessData = [
	{
		id: 1,
		title: 'DFOS 드론 플랫폼',
		desc: '다목적 관리와 드론 정찰을 위한 통합 드론 소프트웨어 플랫폼',
		img: '/src/assets/img/busi_01.png',
		link: '#',
	},
	{
		id: 2,
		...
		img: '/src/assets/img/busi_02.png',
		link: '#',
	},
	{
		id: 3,
		...
		img: '/src/assets/img/busi_03.png',
		link: '#',
	},
	{
		id: 4,
		title: 'R&D 및 운영 시스템',
		desc: '첨단 기술 기반 연구개발과 운영 시스템 통합 지원하며 보유 중인 기술과 솔루션을 용역 및 제안 사업에 적용하여 고객의 전문성과 역량 강화를 제시',
		img: '/src/assets/img/busi_04.png',
		link: '#',
	},
];
